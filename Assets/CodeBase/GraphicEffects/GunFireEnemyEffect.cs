...
namespace CodeBase.GraphicEffects
{
    ...
    public class GunFireEnemyEffect : MonoBehaviour
    {
        private Pool _pool;
        ...
        public class Pool : MonoMemoryPool<Transform, GunFireEnemyEffect>
        {
            protected override void Reinitialize(Transform parent, GunFireEnemyEffect item) {
