...
namespace CodeBase.GraphicEffects
{
    ...
    public class BulletHitEffect : MonoBehaviour
    {
        ...
        public class Pool : MonoMemoryPool<Vector3, Quaternion, BulletHitEffect>
        {
            protected override void Reinitialize(Vector3 position, Quaternion rotation, BulletHitEffect item) {
